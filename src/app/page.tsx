            ...
            <div className="container mx-auto px-2 sm:px-4">
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                <TabsList className="grid w-full grid-cols-4 sm:grid-cols-7 h-auto sm:h-12 gap-1 p-1">
                  ...
                  <TabsTrigger value="april" className="flex items-center justify-center gap-1 sm:gap-2 text-purple-600 data-[state=active]:bg-purple-100 text-xs sm:text-sm py-2 sm:py-0"><Avatar className="h-5 w-5 sm:h-6 sm:w-6 border border-purple-200"><AvatarImage src="/april-avatar.jpg" alt="April" /><AvatarFallback className="bg-gradient-to-br from-purple-500 to-indigo-600 text-white text-[10px] font-bold">A</AvatarFallback></Avatar><span className="hidden sm:inline">April</span></TabsTrigger>
